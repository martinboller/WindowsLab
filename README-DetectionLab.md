...
6. Ensure you are in the Vagrant folrder and run `vagrant up`. This command will do the following:
  ...
  * Provision the DC1 host and configure it as a Domain Controller
...
7. Navigate to https://192.168.10.47:8000 in a browser to access the Splunk instance on logger. Default credentials are admin:changeme (you will have the option to change them on the next screen)
8. Navigate to https://192.168.10.47:8412 in a browser to access the Fleet server on logger. Default credentials are admin:admin123#. Query packs are pre-configured with queries from [palantir/osquery-configuration](https://github.com/palantir/osquery-configuration).
9. Navigate to https://192.168.10.47:8888 in a browser to access the Caldera server on logger. Default credentials are admin:caldera.
...
* Fleet login: https://192.168.10.47:8412 - admin:admin123#
* Splunk login: https://192.168.10.47:8000 - admin:changeme
* Caldera login: https://192.168.10.47:8888 - admin:caldera
